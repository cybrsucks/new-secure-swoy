...
with sqlite3.connect("swoy.db") as conn:
    ...
    cursor.execute("INSERT INTO user(username, email, password, admin, locked) "
                   "VALUES('testing', 'test@test.com', 'be6fded9eba153d774245490f8f4120cebe2a6d3a5467603eca3343de90d6275', 0, 0)")
    cursor.execute("INSERT INTO user(username, email, password, admin, locked) "
                   "VALUES('Super Admin', 'superadmin@swoy.com', '9c9b477f56f1ed5fc4b1d857e11f86664be481e9e7ea5555916448dd72c649ff', 1, 0)")
    cursor.execute("INSERT INTO user(username, email, password, admin, locked) "
                   "VALUES('John Doe', 'johndoe@gmail.com', '7ab048ba3931ced4c81ddc169a632642b38dbc3701ab5b9e616ad83a0eedbcb1', 0, 0)")
